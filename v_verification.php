...
function v_verification_config() {
    $configarray = array(
    "name" => "Payam Resan OTP Verification",
    "description" => "verification mobile numbers",
    "version" => "2.0",
    "author" => "Venon Web Developers, payam-resan.com",
    "language" => "farsi",
    "fields" => array(
		...
		//	"option5" => array ("FriendlyName" => "نام کاربری پنل پیامک", "Type" => "text", "Size" => "15", "Description" => "", "Default" => "demo", ),
			"option6" => array ("FriendlyName" => "توکن", "Type" => "text", "Size" => "15", "Description" => "", "Default" => "demo", ),
			"option7" => array ("FriendlyName" => "الگو", "Type" => "text", "Size" => "15", "Description" => "", "Default" => "demo", ),
